...
def lambda_handler(event, context):
    ...
    number_of_docs = event.get('number_of_docs', 3)  # Default to 3 docs if not specified
    
    # Call the answer_prompt function
    response = answer_prompt(user_prompt, number_of_docs)
